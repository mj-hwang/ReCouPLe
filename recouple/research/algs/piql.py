...
#                 reward_t1 = self.network.reward(obs_1[task_labels==i], action_1[task_labels==i])
#                 reward_t2 = self.network.reward(obs_2[task_labels==i], action_2[task_labels==1])
...
class PIQL(OffPolicyAlgorithm):
    ...
    def validation_step(self, batch: Dict) -> Dict:
        ...
        with torch.no_grad():
            ...
            for i in self.eval_tasks:
                reward_t1 = self.network.reward(obs_1[task_labels==i], action_1[task_labels==i])
                reward_t2 = self.network.reward(obs_2[task_labels==i], action_2[task_labels==i])
